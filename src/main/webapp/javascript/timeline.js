...
(function(){
	...
	$(document).ready(function() {
		...
		$(document).bind('guiLoaded',function(){
			console.log("in GuiLoaded; timeline.js");
			...
			// $.get('http://logicofscientificdiscovery.mads379.staxapps.net/json/discoveries', function(data){
				var arr = eval(data),
			...
			// $.get('http://logicofscientificdiscovery.mads379.staxapps.net/json/scientists', function(data){	
			// 	var arr = eval(data);
			// 	$('#images').trigger('imagesLoaded', { images: arr });
			// });
		});
		console.log("before gui");
		gui();
		console.log("after gui");
		// live bindings 
